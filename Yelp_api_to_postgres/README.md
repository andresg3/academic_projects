...
# Yelp API to Postgress
Small project to fetch data from an API (yelp) and store it into postgres.

You will need to add your own API_KEY in the `config.cnf` file
